...
const FfcVibe = () => {
  ...
  return (
    <div className="w-full max-h-max lg:h-screen relative pt-5 sm:py-0  bg-[#ffff0092] sm:bg-[#fff] broder ">
      <section
        id="fccvibe"
        className="w-[90%] md:h-[90%] mx-auto md:mt-20 hidden sm:grid  sm:grid-cols-3 lg:grid-cols-5 p-5  "
      >
        ...
        <div className="col-span-1 h-full flex flex-col gap-5 p-2">
          <img
            onClick={ViewerHandler}
            src="./img/ffcimg5.png"
            alt=""
      ...
      <div className="w-full flex items-center sm:justify-between gap-2 sm:gap-5 overflow-hidden sm:h-[150px] bg-[#4b1d0d] py-5 px-2 lg:px-10">
